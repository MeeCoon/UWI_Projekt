...
hideAccount("Aktienkapital");
hideAccount("Gesetzliche Reserven");

showAccount("Eigenkapital Einzelunternehmen");

}

if(legal === "GmbH"){

hideAccount("Eigenkapital Einzelunternehmen");
hideAccount("Aktienkapital");
...
showAccount("Aktienkapital");
showAccount("Gesetzliche Reserven");

}


// =============================
// BILANZ AUTOMATISCH BERECHNEN
// =============================

const inputs = document.querySelectorAll(".balanceInput");

function formatCHF(n){
return Number(n).toLocaleString("de-CH") + " CHF";
}
